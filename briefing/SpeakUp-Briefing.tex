...
Comparison of current state vs. proposed workflow:
...
\midrule
Work capture & Fragmented across tools, often untracked & Structured, version-controlled in Git \\
\addlinespace
AI assistance & Outside trust boundary or unavailable & In-boundary, modular, replaceable \\
\addlinespace
Knowledge preservation & At-risk due to personnel transition & Durable artifacts with rationale captured \\
\addlinespace
Automation readiness & Limited by unstructured data & Maximized by structured, tracked systems \\
\addlinespace
Auditability & Manual effort to reconstruct history & Built-in traceability via Git history \\
\bottomrule
\end{tabular}
\end{table}
\end{frame}
