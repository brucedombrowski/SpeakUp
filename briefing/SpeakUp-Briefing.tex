...
\textbf{With the right environment, I can produce significantly more software.}
\end{block}

\vspace{0.5em}

AI-assisted development with proper tooling dramatically multiplies output. The constraint is not capability---it is environment.
