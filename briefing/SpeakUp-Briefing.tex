...
\textbf{Prefer video?} A narrated version of this briefing is available at:\\
\begin{center}
\small\url{https://github.com/brucedombrowski/SpeakUp/tree/main/training}
\end{center}
...
\begin{frame}{Classification Marking Example}
\textbf{This slide demonstrates compliant document marking capability.}

\vspace{0.3em}

\begin{columns}
\column{0.5\textwidth}
\textbf{Banner Marking (Header/Footer)}
\begin{itemize}
\scriptsize
\item CUI//SP-CTI/SP-EXPT
\item UNCLASSIFIED//FOUO
\item UNCLASSIFIED
\end{itemize}

\vspace{0.3em}

\textbf{Portion Marking}
\begin{itemize}
\scriptsize
\item (CUI) This paragraph contains...
\item (U) This paragraph is unclassified...
\item (U//FOUO) For official use only...
\end{itemize}
...
\begin{itemize}
\scriptsize
\item Statement A: Public release
\item Statement B: U.S. Government only
\item Statement C: Government agencies
\item Statement D: DoD and contractors
\item Statement E: DoD components only
\item Statement F: Direct military ops
\end{itemize}

\vspace{0.3em}

\textbf{Destruction Notice}
\begin{itemize}
\scriptsize
\item Destroy by any method preventing reconstruction
\end{itemize}
\end{columns}
...
\begin{center}
\scriptsize
\textit{Reference: 32 CFR Part 2002, NIST SP 800-171, DoD Manual 5200.01}
\end{center}
\end{frame}
...
\textbf{15 commits shown (excerpt)} --- full history is 40+ commits:
...
\includegraphics[width=0.80\linewidth]{theme-screenshots/theme-madrid.png}\\[-0.3em]
\scriptsize Madrid (Default)
\end{minipage} &
\begin{minipage}{0.40\linewidth}\centering
\includegraphics[width=0.80\linewidth]{theme-screenshots/theme-singapore.png}\\[-0.3em]
\scriptsize Singapore (Seahorse)
\end{minipage} \\[0.3em]
\begin{minipage}{0.40\linewidth}\centering
\includegraphics[width=0.80\linewidth]{theme-screenshots/theme-cambridge.png}\\[-0.3em]
\scriptsize CambridgeUS (Dolphin)
\end{minipage} &
\begin{minipage}{0.40\linewidth}\centering
\includegraphics[width=0.80\linewidth]{theme-screenshots/theme-boadilla.png}\\[-0.3em]
...
\scriptsize Each variant is a separate commit. Stakeholder selects preferred style. History preserved.
\end{center}
\end{frame}
