...
\midrule
Fragmented workflows & Disconnected mobile, desktop, and execution environments \\
\midrule
Limited AI in trusted boundaries & Workflow degradation to stay compliant \\
\midrule
Broadcast email as work proxy & Reduced signal-to-noise; interrupts deep effort \\
\midrule
Untracked coordination systems & Limited traceability and auditability \\
\midrule
Knowledge attrition risk & Personnel transition threatens institutional knowledge \\
\bottomrule
\end{tabular}
\end{table}
\end{frame}
