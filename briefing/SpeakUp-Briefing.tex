...
\draw[arrow] (ide) -- (git);
\draw[arrow, dashed] (ide) to[bend right=30] node[below, font=\footnotesize] {Iteration as needed} (mobile);
\end{tikzpicture}
\end{center}
...
\begin{tabular}{cc}
\includegraphics[width=0.35\textwidth]{theme-screenshots/theme-madrid.png} &
\includegraphics[width=0.35\textwidth]{theme-screenshots/theme-singapore.png} \\
\footnotesize Madrid/Default & \footnotesize Singapore/Seahorse \\[1em]
\includegraphics[width=0.35\textwidth]{theme-screenshots/theme-cambridge.png} &
\includegraphics[width=0.35\textwidth]{theme-screenshots/theme-boadilla.png} \\
\footnotesize CambridgeUS/Dolphin & \footnotesize Boadilla/Crane \\
\end{tabular}
